...
public class EditButtonActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_typeAdapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_dropdown_item, com.itii.andropad.pad.Button.s_BUTTON_TYPES);
		...
		m_sizeAdapter = new ArrayAdapter<Float>(this,
				android.R.layout.simple_spinner_dropdown_item, com.itii.andropad.pad.Button.s_BUTTON_SIZES);
